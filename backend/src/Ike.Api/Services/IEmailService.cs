...
public interface IEmailService
{
    ...
    Task<bool> SendPermitDocumentationPackageToClientAsync(Guid jobPermitId, byte[]? primaryPdf, string? primaryPdfFileName, string? toEmail = null, CancellationToken ct = default);
