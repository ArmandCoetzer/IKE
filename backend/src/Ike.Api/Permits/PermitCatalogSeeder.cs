...
/// <summary>
/// Ensures global (CompanyId null) IKE permit types and default templates exist; refreshes WA trigger IDs for legacy fallback.
/// </summary>
public static class PermitCatalogSeeder
{
    ...
    {
        var definitions = IkePermitTemplateCatalog.All;
