...
public static class IkePermitFormFieldSets
{
    ...
    {
        "ike.work_authorisation" => Array.Empty<PermitFormFieldDefinition>(),
        "ike.high_risk_situations" => Concat(General, HighRisk),
        "ike.traffic" => Concat(General, Traffic),
        "ike.body_mechanics_tools" => Concat(General, BodyMechanics),
        "ike.ppe" => Concat(General, Ppe),
        "ike.work_permit_commitments" => Concat(General, WorkPermitCommitments),
        "ike.lifting_operations" => Concat(General, Lifting),
        "ike.energy_isolation_powered_systems" => Concat(General, EnergyIsolation),
        "ike.confined_space_entry" => Concat(General, ConfinedSpace),
        "ike.line_of_fire" => Concat(General, LineOfFire),
        "ike.work_at_height" => Concat(General, WorkAtHeight),
        "ike.hot_work" => Concat(General, HotWork),
        "ike.excavation_work" => Concat(General, Excavation),
        _ => Concat(General, [])
    };
