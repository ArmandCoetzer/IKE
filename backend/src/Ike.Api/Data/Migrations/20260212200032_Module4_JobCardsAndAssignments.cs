...
{
    /// <inheritdoc />
    public partial class Module4_JobCardsAndAssignments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobCards_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                name: "JobCardAssignments",
                columns: table => new
                {
                    JobCardId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AssignedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AssignedById = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobCardAssignments", x => new { x.JobCardId, x.UserId });
                    table.ForeignKey(
                        name: "FK_JobCardAssignments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCardAssignments_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCards_ServiceRequestId",
                table: "JobCards",
