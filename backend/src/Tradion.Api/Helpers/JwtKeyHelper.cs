...
public static class JwtKeyHelper
{
    ...
    public static readonly string TestingJwtKeyBase64 =
        Convert.ToBase64String(Encoding.UTF8.GetBytes("Tradion-Test-JWT-Key-32-Chars!!!"));
    ...
    public static byte[] ResolveValidatedSigningKeyBytes(IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        if (environment.IsEnvironment("Testing"))
            ...
            throw new InvalidOperationException(
                ...
                "For local development use: dotnet user-secrets set Jwt:Key \"<base64>\" --project Tradion.Api, environment variable Jwt__Key, or Jwt:Key in appsettings.Development.json.");
