...
/// <summary>
/// Thirteen permit definitions: Work Authorisation (master) plus twelve DVCP safety-rule templates with checklists.
/// </summary>
public static class DvcpPermitTemplateCatalog
{
    ...
    private static IEnumerable<IPermitCatalogDefinition> Build()
    {
        yield return new Def(
            "dvcp.work_authorisation",
            "Work Authorisation",
            "Master permit — full Work Authorisation form (structured JSON).",
            isWorkAuthorisation: true,
            usesWaForm: true,
            lines: Array.Empty<PermitChecklistLine>(),
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.work_authorisation"));

        yield return new Def(
            "dvcp.high_risk_situations",
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.high_risk_situations"));
        ...
        yield return new Def(
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.traffic"));

        yield return new Def(
            "dvcp.body_mechanics_tools",
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.body_mechanics_tools"));
        ...
        yield return new Def(
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.ppe"));

        yield return new Def(
            "dvcp.work_permit_commitments",
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.work_permit_commitments"));

        yield return new Def(
            "dvcp.lifting_operations",
            "Lifting Operations",
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.lifting_operations"));

        yield return new Def(
            "dvcp.energy_isolation_powered_systems",
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.energy_isolation_powered_systems"));

        yield return new Def(
            "dvcp.confined_space_entry",
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.confined_space_entry"));
        ...
        yield return new Def(
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.line_of_fire"));
        ...
        yield return new Def(
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.work_at_height"));
        ...
        yield return new Def(
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.hot_work"));

        yield return new Def(
            "dvcp.excavation_work",
            "Excavation Work",
            ...
            formFields: DvcpPermitFormFieldSets.ForStableKey("dvcp.excavation_work"));
    }
