...
const TOKEN_KEY = 'ike_token';
const TOKEN_PERSIST_KEY = 'ike_token_persist';
const RETURN_URL_KEY = 'ike_return_url';
...
export class AuthService {
  ...
  private meRequest$: Observable<AuthResponse> | null = null;
  ...
  me(): Observable<AuthResponse> {
    ...
    this.meRequest$ = this.http.get<AuthResponse>(`${API}/me`).pipe(
      timeout(10000),
      tap((res) => this.applyAuthResponse(res)),
      finalize(() => {
        this.meRequest$ = null;
